    ...
    */
     public static function raTing(){
        ...
        return Html::br().
          ...
          <span id="rateStatus" class="label label-important">'.__('Rating this','minishop').'</span>
          <span id="ratingSaved">Saved!</span>'.Html::br();
      }
    }
